...
/**
 * Shop_CT_Geo_IP Class.
 */
class Shop_CT_Geo_IP {
	...
	public static function log( $message ) {
		if ( ! class_exists( 'Shop_CT_Logger' ) ) {
			include_once('class-shop-ct-logger.php');
		}

		if ( empty( self::$log ) ) {
			self::$log = new Shop_CT_Logger();
		}
	 ...
	 * Setup segments.
	 *
	 * @return Shop_CT_Geo_IP instance
	 */
	 ...
	 *
*@return Shop_CT_Geo_IP_Record instance
	 */
	private function _common_get_record( $seek_country ) {
		...
		$record                 = new Shop_CT_Geo_IP_Record();
		$record_buf_pos         = 0;
